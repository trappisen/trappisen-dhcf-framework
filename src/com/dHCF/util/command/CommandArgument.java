...
public abstract class CommandArgument
{
    ...
    public CommandArgument(String name, String description) { this(name, description, (String)null); }



    public CommandArgument(String name, String description, String permission) { this(name, description, permission, ArrayUtils.EMPTY_STRING_ARRAY); }



    public CommandArgument(String name, String description, String[] aliases) { this(name, description, null, aliases); }
    ...
    public boolean isPlayerOnly() { return this.isPlayerOnly; }
    ...
    return 31 * result + ((this.aliases != null) ? Arrays.hashCode(this.aliases) : 0);
}
}
